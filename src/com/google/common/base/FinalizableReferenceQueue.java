...
public class FinalizableReferenceQueue
{
  ...
  private static Class<?> loadFinalizer(FinalizerLoader... paramVarArgs)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      Class localClass = paramVarArgs[j].loadFinalizer();
      if (localClass != null) {
        return localClass;
      }
    }
    ...
    implements FinalizableReferenceQueue.FinalizerLoader
  {
    ...
    public Class<?> loadFinalizer()
    {
      ...
      //   0	38	0	this	SystemLoader
      //   23	1	1	localSecurityException	java.lang.SecurityException
      //   3	8	2	localClassLoader	ClassLoader
      //   5	17	3	localObject	Object
      //   34	1	4	localClassNotFoundException	ClassNotFoundException
      //   16	3	5	localClass	Class
      // Exception table:
      //   from	to	target	type
